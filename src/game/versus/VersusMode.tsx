...
export function VersusMode({ onExit }: { onExit: () => void }) {
  ...
  useEffect(() => { if (me) { setLocalAttackMeter(me.attackMeter); setLocalActiveAttacks(me.activeAttacks ?? []); } }, [me?.attackMeter, me?.activeAttacks]);
